...
<!--          </ul>-->
        ...
        <li><a href="<?php echo __HOST__; ?>/user/allusers" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th"></span><p>Contact list</p></a></li>
        ...
        <li><a href="<?php echo __HOST__; ?>/user/calendar" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-calendar"></span><p>Calendar</p></a>
<!--          <ul class="sub-menu">-->
