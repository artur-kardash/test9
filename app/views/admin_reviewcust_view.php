...
<div class="modal fade" id="editcust"  tabindex="-1" role="dialog" aria-labelledby="editCampaign">
    ...
    <form id="editCliorm" enctype="multipart/form-data" action="<?php echo $host . "/admin/"; ?>updateprofilcust" method="post">
