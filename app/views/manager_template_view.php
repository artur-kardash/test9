...
<main class="page-content content-wrap container">
  <div class="navbar">
    <div class="navbar-inner">
      ...
      <div class="logo-box">
        <a href="admin" class="logo-text"><span>Software Project</span></a>
      </div><!-- Logo Box -->
...
<!--              </a>-->
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
              <a href="/manager/logout" class="log-out waves-effect waves-button waves-classic">
  ...
  <div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
      ...
      <ul class="menu accordion-menu">
        ...
        <li><a href="/manager/dashboard" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
        <li class=""><a href="/manager/listing" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-list-alt"></span><p>Listings available</p></a>
         <!--  <ul class="sub-menu">
...
<!--          </ul>-->
        ...
        <li><a href="/manager/appointment" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-usd"></span><p>Appointment</p></a></li>
...
<!--        </ol>-->
    ...
    <div class="page-footer">
      <p class="no-s">2017 &copy; CRM Software Project.</p>
    </div>
  </div><!-- Page Inner -->
</main><!-- Page Content -->
