<div>
  <div class="form-group add">
   <a href="<?php echo $host . "/admin/addcustomer?id=".$data['inf']['id'];?>"><input type="submit" class="btn btn-primary"  value="Add new customer" ></a>
</div>
</div>
...
<div style="display: block; float: left; width: 25%; position: relative;">
  ...
  <table>
    ...
    <div class="customers">
        <h1><?php echo $data['inf']['firstname']?> customers</h1>
      <table>
          <thead>
            <tr>
              <th width="5%" >ID</th>
